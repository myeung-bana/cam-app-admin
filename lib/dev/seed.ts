...
export const SEED_ADMIN_USERS: AdminUser[] = [
  {
    ...
    status: "active",
    phone: null,
    notes: "Primary Memo instance administrator",
  ...
  },
  {
    ...
    name: "Jordan Lee",
    email: "jordan@memo.example.com",
    role: "admin",
    status: "active",
    phone: "+44 7700 900789",
    notes: "Operations lead — events and client onboarding",
    last_login_at: "2026-06-05T16:20:00Z",
    created_at: "2026-01-15T11:00:00Z",
  },
  {
    id: "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa02",
    name: "Sam Patel",
    email: "sam@memo.example.com",
    role: "admin",
    status: "inactive",
    phone: null,
    notes: "Former contractor — account deactivated",
    last_login_at: "2026-03-20T08:45:00Z",
    created_at: "2026-02-01T14:00:00Z",
  },
];

export const SEED_EVENT_TYPE_TAXONOMY: EventTypeTaxonomy[] = [
  {
    id: "tax-et-wedding",
    kind: "event-types",
    slug: "wedding",
  ...
  },
  {
    ...
    slug: "corporate",
    label: "Corporate",
    description: "Retreats, conferences, and team events",
    sort_order: 2,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    ...
    description: "Graduations, anniversaries, and personal milestones",
    sort_order: 3,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    ...
    kind: "event-types",
    slug: "social",
    label: "Social / private",
    description: "Private gatherings and social events",
    sort_order: 4,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    ...
    slug: "community",
    label: "Community",
    description: "Community meetups and public events",
    sort_order: 5,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    ...
    slug: "other",
    label: "Other",
    description: "Custom or uncategorized event types",
    sort_order: 6,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
...
export const SEED_CHALLENGE_TAXONOMY: ChallengeTaxonomy[] = [
  {
    id: "tax-ch-wedding-1",
    kind: "challenges",
    slug: "candid-laugh",
    label: "Capture a candid laugh",
    description: "A natural moment of joy",
    icon: "📸",
    is_required: false,
    event_type_slug: "wedding",
    sort_order: 0,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  ...
  },
  {
    ...
    slug: "toast-moment",
    label: "Toast moment",
    description: "Clink those glasses",
    icon: "🥂",
    is_required: false,
    event_type_slug: "wedding",
    sort_order: 2,
  ...
  },
  {
    id: "tax-ch-wedding-4",
    kind: "challenges",
    slug: "photo-with-couple",
    label: "Photo with the couple",
    description: "A shot with the happy couple",
    icon: "👰",
    is_required: true,
    event_type_slug: "wedding",
    sort_order: 3,
  ...
  },
  {
    ...
    kind: "challenges",
    slug: "best-venue",
    label: "Best venue shot",
    description: "Capture the venue at its best",
    icon: "🌅",
    is_required: false,
    event_type_slug: "wedding",
    sort_order: 4,
  ...
  },
  {
    ...
    icon: "👥",
    is_required: true,
    event_type_slug: "corporate",
    sort_order: 0,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    id: "tax-ch-corporate-2",
    kind: "challenges",
    slug: "presentation",
    label: "Presentation moment",
    description: "Someone on stage or presenting",
    icon: "🎤",
    is_required: false,
    event_type_slug: "corporate",
    sort_order: 1,
  ...
  {
    id: "tax-ch-corporate-3",
    kind: "challenges",
    slug: "networking",
    label: "Networking",
    description: "People connecting over coffee",
    icon: "☕",
    is_required: false,
    event_type_slug: "corporate",
    sort_order: 2,
  ...
  {
    id: "tax-ch-birthday-1",
    kind: "challenges",
    slug: "cake-moment",
    label: "Cake moment",
    description: "Blowing out candles or cutting cake",
    icon: "🎂",
    is_required: true,
    event_type_slug: "birthday",
    sort_order: 0,
    active: true,
    created_at: "2025-12-01T09:00:00Z",
  },
  {
    id: "tax-ch-birthday-2",
    kind: "challenges",
    slug: "group-selfie",
    label: "Group selfie",
    description: "Selfie with friends",
    icon: "🤳",
    is_required: false,
    event_type_slug: "birthday",
    sort_order: 1,
